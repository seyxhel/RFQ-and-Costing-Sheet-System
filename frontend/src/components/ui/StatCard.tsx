...
const colorMap = {
  green:  { bg: 'bg-green-50 dark:bg-green-900/30', icon: 'text-[#3BC25B]' },
...
export function StatCard({ title, value, icon: Icon, trend, subtext, color = 'green' }: StatCardProps) {
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 p-6">
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          {trend && (
            <div className={`flex items-center gap-1 mt-2 text-xs font-medium ${trend.isPositive ? 'text-green-600 dark:text-green-400' : 'text-red-500 dark:text-red-400'}`}>
